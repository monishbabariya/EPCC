...
**Reference Standards:** X8_GlossaryENUMs_v0_3.md, M34_SystemAdminRBAC_Spec_v1_0.md, M01_ProjectRegistry_Spec_v1_0.md, M02_StructureWBS_Spec_v1_0.md
...
| PROJECT_DIRECTOR | Master Gantt (own) + variance bar | Look-ahead Gantt, milestone timeline | — |
...
### 13.3.4 M04 — Execution Capture

| Role | Primary View | Secondary Widgets | Hidden |
|---|---|---|---|
| PMO_DIRECTOR | Progress S-curve + NCR pipeline funnel | NCR heatmap, HSE calendar | — |
| PROJECT_DIRECTOR | Progress S-curve + NCR list (own) | Productivity trend | — |
| **SITE_MANAGER** | **Today's progress entry form + active NCRs** (own packages) | HSE incidents this week, materials delivered | Strategic |
| QS_MANAGER | Measurement entry + BOQ progress | NCR status | — |
| COMPLIANCE_MANAGER | NCR pipeline funnel + HSE calendar | NCR heatmap by package | — |
...
### 13.3.6 M06 — Financial Control

| Role | Primary View | Secondary Widgets | Hidden |
|---|---|---|---|
| FINANCE_LEAD | **Capital Funnel** ⭐ | Cashflow time-series, payment aging, vendor outstanding | — |
| PMO_DIRECTOR | Capital Funnel (read primary) | Margin by package, variance bar | — |
| PROJECT_DIRECTOR | Capital Funnel (own project) | Recent payments, RA bills due | Cross-project |
| PROCUREMENT_OFFICER | Vendor outstanding bar + PO status | Procurement spend trend | Internal margins |
| SITE_MANAGER | Capital Funnel (% only, no ₹) | — | All ₹ values |
...
*v0.1 — X9 Visualisation Standards Spec locked. 18 sections. 16 chart types. Pipeline Funnel flagship pattern. Role-based default views per module. Decision-first principle foundational. Awaiting first use in Round 17 M03 Wireframes.*
